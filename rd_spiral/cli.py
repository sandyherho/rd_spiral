...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Output files will be saved in ../outputs/ and ../logs/ (outside package)"
    )
    ...
    if not os.path.exists(args.config):
        # Try looking in package configs directory
    ...
    try:
        ...
        print("\nSuccess! Check outputs/ and logs/ directories.")
